...
#TODO-1: Create an empty List called "display". For each letter in the chosen word, add a "_" to 'display'. So if the chosen word was "apple", display should be ["_", "_", "_", "_", "_"] with 5 "_" representing each letter to guess. 
...
#TODO-3: - Print 'display' and you should see the guessed letter in the correct position and the other letters replaced with "_".
print(display)
